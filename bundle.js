...
exports.setAudioPosition = exports.pauseAudio = exports.playAudio = exports.initializeAudio = exports.fetchComments = exports.Types = undefined;
...
var tick = function tick(dispatch) {
    dispatch({
        type: Types.TICK,
...
var fetchComments = function fetchComments(videoId) {
    console.log('fetchComments');
    return function (dispatch) {
        Api.fetchComments(videoId).then(function (comments) {
            dispatch({
...
var setAudioPosition = function setAudioPosition(position) {
    return function (dispatch) {
        setTimeout(function () {
...
var initializeAudio = function initializeAudio(audioElement) {
    audio = audioElement;
    return function (dispatch) {
...
exports.setAudioPosition = setAudioPosition;
...
var _componentsConnect = __webpack_require__(189);
...
exports.fetchComments = undefined;
...
var API_KEY = "AIzaSyAihlKnwXV_zqg7Sn2TBsZHKwPglURaqBA";
var COMMENTS_URL = "https://www.googleapis.com/youtube/v3/commentThreads";
var fetchComments = function fetchComments(videoId) {
    var request = COMMENTS_URL + "?key=" + API_KEY + "&part=snippet,replies&videoId=" + videoId + "&order=relevance&maxResults=100";
    return _axios2.default.get(request).then(function (responce) {
        return responce.data.items.map(function (item) {
            return item;
        });
    });
};
...
var CountIcon = function CountIcon(_ref) {
    var style = _ref.style,
        ...
        color = _ref$color === undefined ? "#fafafa" : _ref$color,
        _ref$radius = _ref.radius,
        radius = _ref$radius === undefined ? "30px" : _ref$radius;
...
var _reduxActions = __webpack_require__(253);
...
var _reduxStorageMergerSimple = __webpack_require__(256);
...
var _reduxStorage = __webpack_require__(257);

var storage = _interopRequireWildcard(_reduxStorage);

var _reduxStorageEngineLocalstorage = __webpack_require__(255);
...
var reducer = storage.reducer(_reducers2.default);
var engine = (0, _reduxStorageEngineLocalstorage2.default)('my-save-key');
var middleware = storage.createMiddleware(engine);
var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2.default, middleware)(_redux.createStore);
...
load(store).then(function (newState) {
  ...
  return console.log('Failed to load previous state');
});
...
var COMMENTS_RECIEVED_SUCCESS = "COMMENTS_RECIEVED_SUCCESS";
var COMMENTS_RECIEVED_FAILURE = "COMMENTS_RECIEVED_FAILURE";
var AUDIO_PLAY = "AUDIO_PLAY";
var AUDIO_PAUSE = "AUDIO_PAUSE";
var AUDIO_INITIALIZED = "AUDIO_INITIALIZED";
var AUDIO_DURATION_SET = "AUDIO_DURATION_SET";
var TICK = "TICK";

exports.COMMENTS_RECIEVED_SUCCESS = COMMENTS_RECIEVED_SUCCESS;
exports.COMMENTS_RECIEVED_FAILURE = COMMENTS_RECIEVED_FAILURE;
exports.AUDIO_PAUSE = AUDIO_PAUSE;
exports.AUDIO_PLAY = AUDIO_PLAY;
exports.AUDIO_INITIALIZED = AUDIO_INITIALIZED;
exports.TICK = TICK;
exports.AUDIO_DURATION_SET = AUDIO_DURATION_SET;
...
var CommentList = function CommentList(_ref) {
    ...
    return _react2.default.createElement(
        ...
        comments.map(function (comment, i) {
            return _react2.default.createElement(_comment2.default, { key: i, comment: comment });
        })
    );
};
...
var _countIcon = __webpack_require__(67);

var _countIcon2 = _interopRequireDefault(_countIcon);

var _replyList = __webpack_require__(141);
    ...
    _createClass(Comment, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                showReplies = _props.showReplies;

            console.log('comment', showReplies);
            var snippet = comment.snippet,
                replies = comment.replies;
            var _snippet$topLevelComm = snippet.topLevelComment.snippet,
                likeCount = _snippet$topLevelComm.likeCount,
                textDisplay = _snippet$topLevelComm.textDisplay,
                authorDisplayName = _snippet$topLevelComm.authorDisplayName;

            return _react2.default.createElement(
                'li',
                { className: 'list-group-item clickable', onClick: this.handleClick.bind(this) },
                _react2.default.createElement(
                    'h6',
                    null,
                    authorDisplayName
                ),
                _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: textDisplay } }),
                _react2.default.createElement(_countIcon2.default, { count: likeCount, color: '#ffaaff', radius: '30px' }),
                this.state.selected && _react2.default.createElement(_replyList2.default, { replies: replies.comments })
            );
        }
    }]);
    ...
    _createClass(Player, [{
        ...
        value: function renderPlayPauseButton() {
            ...
            if (this.props.isPlaying) {
                return _react2.default.createElement(_reactFontawesome2.default, { name: 'pause-circle player-button-clickable', size: '3x', onClick: this.onPause.bind(this) });
            }
            return _react2.default.createElement(_reactFontawesome2.default, { name: 'play-circle player-button-clickable', size: '3x', onClick: this.onPlay.bind(this) });
        }
    }, {
        key: 'renderButtons',
        value: function renderButtons(duration, src, audioPosition) {
            return _react2.default.createElement(
                'div',
                { className: 'player-button-wrapper' },
                _react2.default.createElement(_timer2.default, { time: duration }),
                _react2.default.createElement(_reactFontawesome2.default, { name: 'backward player-button-clickable', size: '2x' }),
                this.renderPlayPauseButton(),
                _react2.default.createElement(_reactFontawesome2.default, { name: 'forward player-button-clickable', size: '2x' }),
                _react2.default.createElement(_timer2.default, { time: audioPosition })
            );
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: "player" },
                _react2.default.createElement('audio', { src: src, ref: function ref(audio) {
                        _this2.audio = audio;
                    } }),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { initializeAudio: _actions.initializeAudio, playAudio: _actions.playAudio, pauseAudio: _actions.pauseAudio })(Player);
...
var ReplyList = function ReplyList(_ref) {
    ...
    return _react2.default.createElement(
        ...
        replies.map(function (comment) {
            return _react2.default.createElement(_reply2.default, { snippet: comment.snippet, key: comment.snippet.textDisplayName });
        })
    );
};
...
var Reply = function Reply(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: snippet.textDisplay } }),
        _react2.default.createElement(_countIcon2.default, { count: snippet.likeCount, color: '#ffaaff', radius: '30px' })
    );
};
...
var _podCast = __webpack_require__(145);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(_podCast2.default, null);
    }
  }]);
...
var _commentList = __webpack_require__(138);
...
var URL = "http://hwcdn.libsyn.com/p/e/2/5/e25debae5db1b903/p950.mp3?c_id=15042400&expiration=1493539844&hwt=0b4f03e2ea463d3de0ec33b3e7782c89";
...
var PodCast = function (_Component) {
    ...
    function PodCast(props) {
        ...
        return _possibleConstructorReturn(this, (PodCast.__proto__ || Object.getPrototypeOf(PodCast)).call(this, props));
    }
    ...
    _createClass(PodCast, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_player2.default, { src: URL })
            );
        }
    }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { fetchComments: _actions.fetchComments })(PodCast);
...
var AudioReducer = function AudioReducer() {
    ...
    switch (action.type) {
        case _actions.Types.AUDIO_INITIALIZED:
            return _extends({}, state, { duration: action.payload, ready: true });
        case _actions.Types.AUDIO_PLAY:
            return _extends({}, state, { isPlaying: true });
        case _actions.Types.AUDIO_PAUSE:
            return _extends({}, state, { isPlaying: false });
        case _actions.Types.TICK:
        case _actions.Types.AUDIO_DURATION_SET:
            return _extends({}, state, { position: action.payload });
        default:
            return state;
    }
};

exports.default = AudioReducer;
...
var CommentsReducer = function CommentsReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { coments: [] };
    var action = arguments[1];

    switch (action.type) {
        case _actions.Types.COMMENTS_RECIEVED_SUCCESS:
            return {
...
var _commentsReducer = __webpack_require__(147);

var _commentsReducer2 = _interopRequireDefault(_commentsReducer);

var _audioReducer = __webpack_require__(146);

var _audioReducer2 = _interopRequireDefault(_audioReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({
  comments: _commentsReducer2.default,
  audio: _audioReducer2.default
});
...
// module
exports.push([module.i, ".clickable:hover {\n  cursor: pointer; }\n\n.card {\n  box-shadow: 0 19px 38px rgba(0, 0, 0, 0.3), 0 15px 12px rgba(0, 0, 0, 0.22); }\n\n.list {\n  overflow-x: hidden;\n  padding-bottom: 10vh; }\n\n.player {\n  display: flex;\n  position: fixed;\n  opacity: 0.5;\n  height: 10vh;\n  width: 100%;\n  background-color: #808080;\n  justify-content: center;\n  align-items: center;\n  transition: 0.5s;\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  bottom: 0px; }\n\n.player-button-wrapper {\n  display: flex;\n  width: 400px;\n  justify-content: space-around;\n  align-items: center; }\n\n.player-button-clickable:hover {\n  color: #ffffff; }\n\n.player-button-clickable:active {\n  transform: translateY(2px); }\n\n.flex-container {\n  display: flex; }\n\n.loader {\n  border: 5px solid #f3f3f3;\n  -webkit-animation: spin 1s linear infinite;\n  animation: spin 1s linear infinite;\n  border-top: 5px solid #555;\n  border-radius: 50%;\n  width: 50px;\n  height: 50px; }\n\n@keyframes spin {\n  0% {\n    transform: rotate(0deg); }\n  100% {\n    transform: rotate(360deg); } }\n\n.loader-parent {\n  display: flex;\n  justify-content: center;\n  height: 100vh;\n  align-items: center; }\n\n.timer {\n  display: flex;\n  align-items: center;\n  justify-content: center; }\n  .timer p {\n    color: #ffffff;\n    margin: 0; }\n", ""]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37), __webpack_require__(116)(module)))
...
var _utilsStoreShape = __webpack_require__(79);
...
var _utilsWrapActionCreators = __webpack_require__(192);
...
var _handleAction = __webpack_require__(108);
...
var _createAction = __webpack_require__(251);
...
var _createLoader = __webpack_require__(110);
...
var _createMiddleware = __webpack_require__(111);
...
exports['default'] = _extends({}, __webpack_require__(26), {
    createLoader: __webpack_require__(110)['default'],
    createMiddleware: __webpack_require__(111)['default'],
    reducer: __webpack_require__(112)['default']
});
